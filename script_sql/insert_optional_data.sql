...
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,3),(@pins_id,2);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,6),(@pins_id,7);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,8),(@pins_id,9);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,10),(@pins_id,11);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,12),(@pins_id,13);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,14),(@pins_id,15);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,16),(@pins_id,17);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,18),(@pins_id,19);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,20),(@pins_id,21);

insert into Pins(name, release_date, edition_number, serie_id, type_id) value ('World\'s Best Friends Tic & Tac', '2019-08-17', 700, 1, 1);
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,22),(@pins_id,23);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,24),(@pins_id,25);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,26),(@pins_id,27);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,28),(@pins_id,29);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,30),(@pins_id,31);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,32),(@pins_id,33);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,51);

insert into Pins(name, release_date, edition_number, serie_id, type_id) value ('Cast Member PanPan', '2015-04-09', 3015, 11, 1);
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,21);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,52);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,14);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,53);
...
set @pins_id = LAST_INSERT_ID();
insert into Pins_Contributor (pins_id, contributor_id) values (@pins_id, @contributor_id);
insert into Pins_Personnage (pins_id, personnage_id) VALUES (@pins_id,54);
